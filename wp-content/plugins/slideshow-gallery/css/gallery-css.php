...
#<?php echo $styles['wrapperid']; ?> #information { text-align:left; font-family: Arial !important; position:absolute; bottom:0; width:<?php echo ($styles['width'] != "auto") ? ((int) $styles['width'] - 6) . 'px' : '100%'; ?>; height:0; background:<?php echo $styles['infobackground']; ?>; color:<?php echo $styles['infocolor']; ?>; overflow:hidden; z-index:200; opacity:.7; filter:alpha(opacity=70); }
#<?php echo $styles['wrapperid']; ?> #information h3 { color:<?php echo $styles['infocolor']; ?>; padding:4px 8px 3px; margin:0 !important; font-size:14px; font-weight:normal; }
...
#<?php echo $styles['wrapperid']; ?> #image { width:<?php echo ($styles['width'] != "auto") ? ((int) $styles['width'] - 4) . 'px' : 'auto'; ?>; no-repeat; text-align: center;}
#<?php echo $styles['wrapperid']; ?> #image img { border:1px solid #EEEEEE; height:auto; max-width:100%;}
...
#<?php echo $styles['wrapperid']; ?> #slideleft { float:left; width:20px; height:<?php echo ((int) $styles['thumbheight'] + 14); ?>px; background:url('../images/scroll-left.gif') center center no-repeat; background-color:#fff; }
#<?php echo $styles['wrapperid']; ?> #slideleft:hover { background-color:#333; }
#<?php echo $styles['wrapperid']; ?> #slideright { float:right; width:20px; height:<?php echo ((int) $styles['thumbheight'] + 14); ?>px; background:#fff url('../images/scroll-right.gif') center center no-repeat; }
